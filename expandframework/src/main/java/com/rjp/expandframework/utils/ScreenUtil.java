...
public final class ScreenUtil {
    ...
    public static boolean isLandscape() {
        return AppUtil.getApp().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) AppUtil.getApp().getSystemService(Context.KEYGUARD_SERVICE);
        //noinspection ConstantConditions
    ...
    public static boolean isTablet() {
        return (AppUtil.getApp().getResources().getConfiguration().screenLayout
    ...
    private static void adaptScreen(final Activity activity,
        ...
        AppUtil.ADAPT_SCREEN_ARGS.sizeInPx = sizeInPx;
        AppUtil.ADAPT_SCREEN_ARGS.isVerticalSlide = isVerticalSlide;
    }
...
//    }
    ...
    public static void cancelAdaptScreen(Activity activity) {
        AppUtil.cancelAdaptScreen(activity);
    }
    ...
    public static void restoreAdaptScreen(Activity activity) {
        AppUtil.restoreAdaptScreen(activity);
    }
